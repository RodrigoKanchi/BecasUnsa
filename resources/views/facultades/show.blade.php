      ...
      <div class="ev-header">
        <div class="ev-header-left">
          ...
          <div class="ev-title-row">
            ...
            <h1 class="ev-page-title">{{ $facultad->nombre }}</h1>
          </div>
        </div>
      ...
      <div class="ev-show-layout">
        ...
        <div class="ev-show-main">
          ...
          <div class="adm-card ev-profile">
              <div class="ev-profile-name">{{ $facultad->nombre }}</div>
          </div>
            <div class="ev-det-field" style="border-bottom:none">
                <span class="ev-det-label">Estado</span>
                <span class="adm-status active">{{ $facultad->activo ? 'Activo' : 'Inactivo' }}</span>
            </div>

...
<main class="adm-content">
      <div class="ev-header">
        <div class="ev-header-left">
          <span class="ev-back" onclick="history.back()">‹ Volver a Facultades</span>
          <div>
            <div class="ev-title-row">
              <span class="ev-entity-icon">👤</span>
              <h1 class="ev-page-title">Editar Facultad</h1>
      ...
      <div class="ev-alert success" id="alertOk" style="display:none">
        ✅ Facultad actualizado exitosamente.
      ...
      <form id="editForm" method="POST" action="{{route( 'facultades.update' , [ 'facultad' => $facultad->id ] )}} " >
        ...
        <div class="ev-form-layout">
          <div class="ev-form-main">
            ...
            <div class="ev-field">
              ...
              <input class="ev-input" name="nombre" id="f-nombre" type="text" value="{{ $facultad->nombre }}" />
        ...
        <div class="ev-footer">
          <a type="button" class="adm-btn ghost" href="{{ route('facultades.index') }}">Cancelar</a>
